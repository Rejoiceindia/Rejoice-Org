const Tagline = () => {
  return (
    <div className="max-w-7xl mx-auto text-center my-24 px-4 sm:px-6 lg:px-8">
      
        <h1 className="text-5xl font-extrabold tracking-wider leading-16 text-gray-800 dark:text-white"> 
          Revolutionizing <span className="text-[#4F67FF]">Real Estate Tech</span>
          <br /> with Open Source
        </h1>
        
        <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-7xl mx-auto tracking-normal">
