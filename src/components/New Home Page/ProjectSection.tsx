...
const ProjectCard: React.FC<ProjectDetailsType> = ({ projectName, description, image, techStack, contributors, links, projectRoute }) => {
    ...
    <>
      ...
      >
            ...
            >
                ...
                >
                    <h3 className="text-white text-xl font-bold drop-shadow-lg">{projectName}</h3>
                </motion.div>
            </motion.div>
            ...
            <div className="p-6">
                ...
                >
                    <div className="flex -space-x-2 relative">
                        {contributors.map((dev, i) => (
                            ...
                            >
                                <img className="w-8 h-8 rounded-full border-2 border-white dark:border-none transform transition-transform duration-300 hover:scale-110 hover:z-10"
                ...
                >
                    ...
                    >
                        ...
                        <span className=" transition-colors duration-300">Sponsor this project</span>
                    </motion.a>
                </motion.div>
            </div>
      </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            >
                ...
                <motion.p 
                  ...
                  transition={{ duration: 0.5, delay: 0.2 }}
                >
                    Explore our open-source projects that are revolutionizing real estate through 
                    collaboration, innovation, and cutting-edge solutions.
                </motion.p>
            </motion.div>
            ...
            >
                ...
                >
                    ...
                    <motion.p 
                      ...
                      transition={{ duration: 0.5, delay: 0.6 }}
                    >
                        We're working on exciting new open-source projects to further revolutionize real estate technology. 
